    ...
    extend(EditTagModal.prototype, 'fields', function (items: ItemList<Mithril.Children>) {
      items.add(
        ...
        <div className="Form-group">
          <label>{app.translator.trans('prippp-synopsis.admin.settings.excerpt-length.label')}</label>
          <input className="FormControl" type="number" min="0" bidi={this.excerptLength} />
          <div>{app.translator.trans('prippp-synopsis.admin.settings.excerpt-length.help')}</div>
        </div>,
        5
      );
      items.add(
        ...
        <div className="Form-group">
          <div>
            <label className="checkbox">
              ...
              {app.translator.trans('prippp-synopsis.admin.settings.rich-excerpts.label')}
            </label>
          </div>
          <div>{app.translator.trans('prippp-synopsis.admin.settings.rich-excerpts.help')}</div>
        </div>,
        5
      );
    });
